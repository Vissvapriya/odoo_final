...
const OwnerDashboard = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, py: 1 }}>
      <Box sx={{ mb: 3 }}>
        <Typography variant="h5" fontWeight="700" color="text.primary">Owner Dashboard</Typography>
        <Typography variant="body2" color="text.secondary">Real-time business performance & operations overview</Typography>
      </Box>
            ...
            <Box sx={{ width: '100%', height: 300 }}>
              <ResponsiveContainer>
                <AreaChart data={trends} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Area type="monotone" name="Purchase Cost" dataKey="purchases" stroke="#8b7355" strokeWidth={2} fillOpacity={1} fill="url(#purchaseGrad)" />
                </AreaChart>
              </ResponsiveContainer>
            </Box>
          </Paper>
